...
function Fourth(props: any) {
  ...
  return (
    <div className="quiz-container4">
        <div className="center">
          <img onClick={() => {noPlay(); history.push('/fourA')}}src={yes} alt="Q"/>
          <img onClick={() => {yesPlay(); history.push('/fourA'); dispatch(increaseQuiz())}}src={no} alt="Q"/>
        </div>
    </div>
  )
}
